                ...
                HeroicValidator.prototype.findUnsafeAggregations = function (data) {
                    ...
                    var badTags = lodash_1.default.uniq(lodash_1.default.flatMap(this.tagAggregationChecks, function (value, key) {
                        return data
                            .filter(function (_a) {
                            var meta = _a.meta;
                            return meta.scoped["tag_" + key] !== undefined && lodash_1.default.includes(value, meta.scoped["tag_" + key].text);
                        })
                            .map(function (_a) {
                            var meta = _a.meta;
                ...
                HeroicValidator.prototype.checkForWarnings = function (data) {
                    ...
                    if (collapsedKeys.length > 0) {
                        ...
                        if (collapsedKeys.length === 1) {
                            ...
                            message =
                                "Aggregating several of keys <strong>'" + collapsedKeys.slice(0, collapsedKeys.length - 1).join("', '") + "' or '" + collapsedKeys[collapsedKeys.length - 1] + "'</strong> " + 'is probably not what you want. For each key, add a filter or group by aggregation.';
                        }
